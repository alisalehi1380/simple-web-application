<div class="ecaps-sidemenu-area">
    ...
    <div class="ecaps-logo">
        <a href="{{ route('panel.user') }}">
            <img class="desktop-logo" src="{{ asset('Assets/Panel/Assets/img/companyName.png') }}" alt="لوگوی دسک تاپ">
            <img class="small-logo" src="{{ asset('Assets/Panel/Assets/img/companyName.png') }}" alt="آرم موبایل"></a>
    </div>
        ...
        <div class="side-menu-area">
            ...
            <nav>
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="active"><a href="#"><i class="zmdi zmdi-view-dashboard"></i><span>داشبورد</span></a></li>

                    <li class="treeview">
                        <a href="#"><i class="fa fa-newspaper-o"></i> <span>مقالات</span> <i class="fa fa-angle-left"></i></a>
                        <ul class="treeview-menu">
                            <li><a href="{{ route('panel.user.article.create') }}">لیست مقالات</a></li>
