        ...
        <div class="card card-body">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form method="post" action="{{ route('panel.user.article.store') }}" enctype="multipart/form-data">
                        @csrf
...
{{--                                @error('image')<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>@enderror--}}
                        ...
                        <button type="submit" class="btn btn-outline-success mb-2" style="float:left;"><i class="fa fa-save"></i>ایجاد</button>
                    </form>
                </div>
            </div>
        </div>
